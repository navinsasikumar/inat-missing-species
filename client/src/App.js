...
class Display extends Component {
  render() {
    ...
    let resultCount = this.props.results.length;
  ...
  render() {
    return (
      <React.Fragment>
        ...
        <Display results={this.props.results} filter={this.state.filters}/>
      </React.Fragment>
    )
  }
}
...
class App extends Component {
  ...
  callApi = async () => {
    const resp = await fetch('/api/observations/species');
  ...
  render() {
    return (
      <div className="App">
        ...
        <MainBody results={this.state.results} />
      </div>
    );
  }
}
